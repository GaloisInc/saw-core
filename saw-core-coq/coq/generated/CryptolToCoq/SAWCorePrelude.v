...
Axiom gen_at_BVVec : forall (n : @SAWCoreScaffolding.Nat), forall (len : @bitvector n), forall (a : Type), forall (x : @BVVec n len a), @SAWCoreScaffolding.EqP (@BVVec n len a) (@genBVVec n len a (@atBVVec n len a x)) x .
