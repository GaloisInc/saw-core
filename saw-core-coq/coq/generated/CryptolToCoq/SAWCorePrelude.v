...
Axiom bvEqToEqNat : forall (n : @SAWCoreScaffolding.Nat), forall (v1 : @bitvector n), forall (v2 : @bitvector n), @SAWCoreScaffolding.EqP (@bitvector n) v1 v2 -> let var__0   := forall (n1 : @SAWCoreScaffolding.Nat), @bitvector n1 -> @SAWCoreScaffolding.Nat in
  @eqNat (@SAWCoreVectorsAsCoqVectors.bvToNat n v1) (@SAWCoreVectorsAsCoqVectors.bvToNat n v2) .

Axiom bvultToIsLtNat : forall (n : @SAWCoreScaffolding.Nat), forall (v1 : @bitvector n), forall (v2 : @bitvector n), @SAWCoreScaffolding.EqP (@SAWCoreScaffolding.Bool) (@SAWCoreVectorsAsCoqVectors.bvult n v1 v2) (@SAWCoreScaffolding.true) -> let var__0   := forall (n1 : @SAWCoreScaffolding.Nat), @bitvector n1 -> @SAWCoreScaffolding.Nat in
...
Definition listSortGet : @ListSort -> @SAWCoreScaffolding.Nat -> Type :=
  @ListSort__rec (fun (_1 : @ListSort) => @SAWCoreScaffolding.Nat -> Type) (fun (_1 : @SAWCoreScaffolding.Nat) => @SAWCoreScaffolding.EqP (@SAWCoreScaffolding.Bool) (@SAWCoreScaffolding.true) (@SAWCoreScaffolding.false)) (fun (A : Type) (_1 : @ListSort) (rec : @SAWCoreScaffolding.Nat -> Type) => @Nat_cases Type A (fun (n : @SAWCoreScaffolding.Nat) (_2 : Type) => rec n)).
...
| IRT_elemD : forall (Ds : @IRTSubsts As), forall (n : @SAWCoreScaffolding.Nat), @IRT As (@dropIRTs As Ds (@SAWCoreScaffolding.Succ n)) (@atIRTs As Ds n) -> @IRT As Ds (@IRT_varD As n)
