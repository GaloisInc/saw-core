...
preludePrims = HashMap.fromList
  ...
  , ("Prelude.equalNat", toValue ((==) :: Prim.Nat -> Prim.Nat -> Bool))
  , ("Prelude.ltNat"   , toValue ((<) :: Prim.Nat -> Prim.Nat -> Bool))
  ...
  , ("Prelude.bvNeg"   , toValue Prim.bvNeg)
  , ("Prelude.bvUExt"  , toValue Prim.bvUExt)
  , ("Prelude.bvSExt"  , toValue Prim.bvSExt)
  , ("Prelude.bvTrunc" , toValue Prim.bvTrunc)
  , ("Prelude.bvUDiv"  , toValue (\w x y -> maybeDiv0 (Prim.bvUDiv w x y)))
  , ("Prelude.bvURem"  , toValue (\w x y -> maybeDiv0 (Prim.bvURem w x y)))
  , ("Prelude.bvSDiv"  , toValue (\w x y -> maybeDiv0 (Prim.bvSDiv w x y)))
  , ("Prelude.bvSRem"  , toValue (\w x y -> maybeDiv0 (Prim.bvSRem w x y)))
